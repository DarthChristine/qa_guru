...
public class RandomUtils {
    ...
    public static String getRandomString(int length) { //метода возвращает рандомную строчку длины length
    ...
    public static String getRandomMessage(int min, int max) { //рандомное сообщение длины от мин до макс
    ...
    public static int getRandomInt(int min, int max) { //возвращает рандомное число инт от мин до макс
        Random r = new Random();

        return r.nextInt((max - min) + 1) + min;
    }

    public static String getRandomPhone() { //рандомный номер телефона
    ...
    public static String getRandomEmail() { //генерит рандомный имейл
